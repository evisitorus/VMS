exports.config = {
  ...
  gherkin: {
    ...
    steps: [
          ...
          './tests/acceptance/step_definitions/LandingPageTableList.steps.js',
          ...
          './tests/acceptance/step_definitions/Dashboard.steps.js',
          './tests/acceptance/step_definitions/Logout.steps.js',
          './tests/acceptance/step_definitions/InformasiUmum.steps.js',
          './tests/acceptance/step_definitions/TataKelolaPerusahaan.steps.js',
          './tests/acceptance/step_definitions/PengajuanVerifikasi.steps.js',
        ]
  },
  plugins: {
    screenshotOnFail: {
