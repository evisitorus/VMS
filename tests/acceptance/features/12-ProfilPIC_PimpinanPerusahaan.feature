  ...
  Scenario: Positif Scenario for adding information in regards to "Pimpinan dan Pengurus Perusahaan" 
     Given The Vendor still on "PIC" form 
	   ...
	   "kartuIdentitas: "browse"
        ...
        """
	    And The Vendor upload "Kartu Identitas" not more than 2 MB
        ...
        And The Vendor will see first 5 lists  of "Pemegang Saham" on "Pimpinan dan Pengurus Grid"
        """
        {
  ...
  Scenario: Negatif Scenario for adding information in regards to "Pimpinan dan Pengurus" 
     Given The Vendor still on "PIC" form 
      When The Vendor already define information from "Pimpinan dan Pengurus" 
       And The Vendor wants to add information in regards to "Pimpinan dan Pengurus" on "Pimpinan dan Pengurus Grid" which part of "PIC" form 
       And The Vendor must clicks button "Tambah" where found on the right-bottom of "Pimpinan dan Pengurus Grid" to add records information in regards to "Pimpinan dan Pengurus"
       And The Vendor will see pop-up form of "Tambah Pimpinan" which appear in front of "PIC" form
