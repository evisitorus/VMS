...
Feature: Vendor Basic - Completing vendor information
    ...
    Scenario:
        ...
        When The Vendor wants to add information regarding to "Korespondensi" on "Korespondensi Grid" which part of "Informasi Umum" page
        ...
        And The Vendor will see "Korespondensi" data in the "Korespondensi grid"
