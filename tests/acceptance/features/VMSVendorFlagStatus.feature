...
#================================================================================================================================================
  ...
  #Vendor Aktif adalah Vendor yang sudah melakukan registrasi dan aktivasi namun belum melengkapi informasi dan memiliki predikat sebagai Vendor Basic
   Scenario:
    Given The Vendor already register his/her VMS company account 
     When The Vendor clicks "activated" link which sent to his/her email account 
      And The Vendor define credential access by defining his/her password for VMS 
      And The Vendor try to log-in to VMS by using his/her new VMS account 
