 ...
 #positive scenario 
  ...
  Scenario: The Vendor input wrong Email and Password
    ...
    Contoh:
        ...
        | [negative case - wrong email]      | Login failed | admin@abadijaya.co | P0intBreak!23  | Email tidak terdaftar, silahkan inputkan email benar atau lakukan registrasi jika anda belum memiliki akun.|
        | [negative case - wrong password]   | Login failed | 08123133133        | P0intBreak     | Password yang anda inputkan salah, silahkan ulangi!                                                        |
