...
Feature: Vendor Basic - Completing vendor information
    ...
    Scenario:
        ...
        And The Vendor must click "Simpan" button where found on the "Left-bottom" of "SPT" form
        And The Vendor must select "Ya" option for "SPT" form
        And The Vendor see updated "SPT" data in the form
