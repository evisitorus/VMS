...
Feature: Vendor Basic - Completing vendor information
    ...
    Scenario:
        ...
        And The Vendor must clicks button "Tambah" where found on the Right-bottom of "Sertifikasi dan Dokumen Khusus Grid"
        Then The Vendor will see "Sertifikasi dan Dokumen Khusus" form to add records regarding to "Sertifikasi dan Dokumen Khusus"
            """
            {
                "no": "autonumber",
                "namaDokumen": "SIUJK",
        ...
        And The Vendor will not see the "Sertifikasi dan Dokumen Khusus" data in the "Sertifikasi dan Dokumen Khusus grid"
