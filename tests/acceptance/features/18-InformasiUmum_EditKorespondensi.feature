...
Feature: Vendor Basic - Completing vendor information
    ...
    Scenario:
        ...
        And The Vendor see "Korespondensi" form fill with data from chosen row
            ...
            """
        When The Vendor has fill all field And The Vendor wants to save information of "Korespondensi"
        ...
        And The Vendor see "Korespondensi" data in the "Korespondensi grid"
